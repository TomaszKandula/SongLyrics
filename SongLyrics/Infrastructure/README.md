...
1. `Add-Migration -StartupProject SongLyrics -Project SongLyrics -Context MainDbContext -OutputDir Infrastructure\Database\Migrations <name>`
1. `Update-Database -StartupProject SongLyrics -Project SongLyrics -Context MainDbContext`

To remove migration:

1. `Remove-Migration -StartupProject SongLyrics -Project SongLyrics -Context MainDbContext`
